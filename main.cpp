...
CD3DXAnimation* g_pAnimation1=NULL;//动画
...
HRESULT Objects_Init()
{
	...
	*/
	g_pAnimation1=new CD3DXAnimation(g_pd3dDevice);
	g_pAnimation1->Init(L"tiny.x");
...
void Direct3D_Render(HWND hwnd)
{
	...
	*/
	...
	g_pAnimation1->SetMatrix(&g_matWorld);
	g_pAnimation1->UpdateAnimation(0.001f * 1);
